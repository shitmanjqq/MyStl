...
{
    if (id == 0) return MyStl::make_tuple(3.8, 'A', "Lisa Simpson");
    if (id == 1) return MyStl::make_tuple(2.9, 'C', "Milhouse Van Houten");
    if (id == 2) return MyStl::make_tuple(1.7, 'D', "Ralph Wiggum");
